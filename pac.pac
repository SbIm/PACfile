...
function _check_patterns(i,o,c,p) {
	return i.hasOwnProperty(o)&&_check_regex_list(i[o],
	c.slice(p+o.length))?!0:_check_regex_list(i.any,
	c.slice(p))?!0:!1
}
...
var _http_map={
		...
		proxy:{ any:[/^[^/]*\.dpool\.sina\.com\.cn\/iplookup/i,/^[^/]*\/vrs_flash\.action/i],
				...
				"api.letv.com":[/^\/streamblock/i,/^\/mms\/out\/video\/play/i,/^\/mms\/out\/common\/geturl/i,/^\/geturl/i,/^\/api\/geturl/i,
				/^\/getipgeo$/i],
	...
	_proxy_str="PROXY proxy.uku.im:8888";